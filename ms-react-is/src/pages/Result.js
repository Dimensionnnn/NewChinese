...
class Result extends React.Component {
  ...
  setOne = () => {
    const contentOne =
      '<p style="color:orange">一级文本,</p> <p style="color:black">二级文本. </p>';
  ...
  setTwo = () => {
    const contentTwo =
      '<p style="color:black;">一级文本, <p style="color:orange">二级文本.</p></p>';
    if (this.myRef.current) {
  ...
  render() {
    return (
      <>
        <div style={this.upStyle}>分析结果： 适合HSK 6级以上的学习者</div>
          ...
          <div style={{ float: "left" }}>
            <form method="post">
              ...
              <div style={{ display: "inline-block" }}>
                <button style={this.buttonStyle} id="text_download">
                  下载当前文本
                </button>
              </div>
              <div style={{ display: "inline-block" }}>
                <button id="btn_analyze2" style={this.buttonStyle}>
                  再次分析
                </button>
              </div>
              <button
