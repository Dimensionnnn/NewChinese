            ...
            <div style={downStyle}>
                <div style={{ float: 'left' }}>
                    <BundledEditor
                        ...
                        initialValue='<p>一级文本,<br/><br/>二级文本.</p>'
                        init={{
                            language: 'zh-Hans',
                            width: 590,
                            ...
                            min_height: 540,
                            menubar: false,
                            plugins: 'save  searchreplace autolink fullscreen link charmap pagebreak insertdatetime advlist lists wordcount',
                            toolbar: 'link  newdocument save searchreplace undo redo cut copy blockquote removeformat forecolor backcolor bold italic underline strikethrough charmap\n' +
                    ...
                    <button style={buttonStyle} onClick={log}>获取当前文本</button>
                </div>
